...
int main(int argc, char* argv[]) {
	...
	std::cout << "EAX=4 and EAX=Bh: [Intel Thread/Core and Cache Topology]: " << endl;
	...
	(eaxBits[1]) ? std::cout << "EAX bit 1: " << eaxBits[1] << ": [SUPPORTED] SM3 hash extensions - (sm3)" << endl : std::cout << "EAX bit 1: " << eaxBits[1] << ": [UNSUPPORTED] SM3 hash extensions - (sm3)" << endl;
	(eaxBits[2]) ? std::cout << "EAX bit 2: " << eaxBits[2] << ": [SUPPORTED] SM4 cipher extensions - (sm4)" << endl : std::cout << "EAX bit 2: " << eaxBits[2] << ": [UNSUPPORTED] SM4 cipher extensions - (sm4)" << endl;
	(eaxBits[3]) ? std::cout << "EAX bit 3: " << eaxBits[3] << ": [SUPPORTED] Remote Atomic Operations on integers: AADD, AAND, AOR, AXOR instructions - (rao-int)" << endl : std::cout << "EAX bit 3: " << eaxBits[3] << ": [UNSUPPORTED] Remote Atomic Operations on integers: AADD, AAND, AOR, AXOR instructions - (rao-int)" << endl;
	(eaxBits[4]) ? std::cout << "EAX bit 4: " << eaxBits[4] << ": [SUPPORTED] AVX Vector Neural Network Instructions (VNNI) (VEX encoded) - (avx-vnni)" << endl : std::cout << "EAX bit 4: " << eaxBits[4] << ": [UNSUPPORTED] AVX Vector Neural Network Instructions (VNNI) (VEX encoded) - (avx-vnni)" << endl;
	(eaxBits[5]) ? std::cout << "EAX bit 5: " << eaxBits[5] << ": [SUPPORTED] AVX-512 instructions for bfloat16 numbers - (avx512-bf16)" << endl : std::cout << "EAX bit 5: " << eaxBits[5] << ": [UNSUPPORTED] AVX-512 instructions for bfloat16 numbers - (avx512-bf16)" << endl;
	(eaxBits[6]) ? std::cout << "EAX bit 6: " << eaxBits[6] << ": [SUPPORTED] Linear Address Space Separation (CR4 bit 27) - (lass)" << endl : std::cout << "EAX bit 6: " << eaxBits[6] << ": [UNSUPPORTED] Linear Address Space Separation (CR4 bit 27) - (lass)" << endl;
	(eaxBits[7]) ? std::cout << "EAX bit 7: " << eaxBits[7] << ": [SUPPORTED] CMPccXADD instructions - (cmpccxadd)" << endl : std::cout << "EAX bit 7: " << eaxBits[7] << ": [UNSUPPORTED] CMPccXADD instructions - (cmpccxadd)" << endl;
	(eaxBits[8]) ? std::cout << "EAX bit 8: " << eaxBits[8] << ": [SUPPORTED] Architectural Performance Monitoring Extended Leaf (EAX=23h) - (archperf­monext)" << endl : std::cout << "EAX bit 8: " << eaxBits[8] << ": [UNSUPPORTED] Architectural Performance Monitoring Extended Leaf (EAX=23h) - (archperf­monext)" << endl;
	(eaxBits[9]) ? std::cout << "EAX bit 9: " << eaxBits[9] << ": [SUPPORTED] ? - (dedup)" << endl : std::cout << "EAX bit 9: " << eaxBits[9] << ": [UNSUPPORTED] ? - (dedup)" << endl;
	(eaxBits[10]) ? std::cout << "EAX bit 10: " << eaxBits[10] << ": [SUPPORTED] Fast zero-length REP MOVSB - (fzrm)" << endl : std::cout << "EAX bit 10: " << eaxBits[10] << ": [UNSUPPORTED] Fast zero-length REP MOVSB - (fzrm)" << endl;
	(eaxBits[11]) ? std::cout << "EAX bit 11: " << eaxBits[11] << ": [SUPPORTED] Fast short REP STOSB - (fsrs)" << endl : std::cout << "EAX bit 11: " << eaxBits[11] << ": [UNSUPPORTED] Fast short REP STOSB - (fsrs)" << endl;
	(eaxBits[12]) ? std::cout << "EAX bit 12: " << eaxBits[12] << ": [SUPPORTED] Fast short REP CMPSB and REP SCASB - (rsrcs)" << endl : std::cout << "EAX bit 12: " << eaxBits[12] << ": [UNSUPPORTED] Fast short REP CMPSB and REP SCASB - (rsrcs)" << endl;
	(eaxBits[13]) ? std::cout << "EAX bit 13: " << eaxBits[13] << ": [SUPPORTED] Reserved" << endl : std::cout << "EAX bit 13: " << eaxBits[13] << ": [UNSUPPORTED] Reserved" << endl;
	...
	(eaxBits[17]) ? std::cout << "EAX bit 17: " << eaxBits[17] << ": [SUPPORTED] Flexible Return and Event Delivery - (fred)" << endl : std::cout << "EAX bit 17: " << eaxBits[17] << ": [UNSUPPORTED] Flexible Return and Event Delivery - (fred)" << endl;
	(eaxBits[18]) ? std::cout << "EAX bit 18: " << eaxBits[18] << ": [SUPPORTED] LKGS Instruction - (lkgs)" << endl : std::cout << "EAX bit 18: " << eaxBits[18] << ": [UNSUPPORTED] LKGS Instruction - (lkgs)" << endl;
	(eaxBits[19]) ? std::cout << "EAX bit 19: " << eaxBits[19] << ": [SUPPORTED] WRMSRNS instruction (non-serializing write to MSRs) - (wrmsrns)" << endl : std::cout << "EAX bit 19: " << eaxBits[19] << ": [UNSUPPORTED] WRMSRNS instruction (non-serializing write to MSRs) - (wrmsrns)" << endl;
	(eaxBits[20]) ? std::cout << "EAX bit 20: " << eaxBits[20] << ": [SUPPORTED] NMI source reporting - (nmi_src)" << endl : std::cout << "EAX bit 20: " << eaxBits[20] << ": [UNSUPPORTED] NMI source reporting - (nmi_src)" << endl;
	(eaxBits[21]) ? std::cout << "EAX bit 21: " << eaxBits[21] << ": [SUPPORTED] AMX instructions for FP16 numbers - (amx-fp16)" << endl : std::cout << "EAX bit 21: " << eaxBits[21] << ": [UNSUPPORTED] AMX instructions for FP16 numbers - (amx-fp16)" << endl;
	(eaxBits[22]) ? std::cout << "EAX bit 22: " << eaxBits[22] << ": [SUPPORTED] HRESET instruction, IA32_HRESET_ENABLE (17DAh) MSR, and Processor History Reset Leaf (EAX=20h) - (hreset)" << endl : std::cout << "EAX bit 22: " << eaxBits[22] << ": [UNSUPPORTED] HRESET instruction, IA32_HRESET_ENABLE (17DAh) MSR, and Processor History Reset Leaf (EAX=20h) - (hreset)" << endl;
	(eaxBits[23]) ? std::cout << "EAX bit 23: " << eaxBits[23] << ": [SUPPORTED] AVX IFMA instructions - (avx-ifma)" << endl : std::cout << "EAX bit 23: " << eaxBits[23] << ": [UNSUPPORTED] AVX IFMA instructions - (avx-ifma)" << endl;
	...
	(eaxBits[25]) ? std::cout << "EAX bit 25: " << eaxBits[25] << ": [SUPPORTED] Reserved" << endl : std::cout << "EAX bit 25: " << eaxBits[25] << ": [UNSUPPORTED] Reserved" << endl;
	(eaxBits[26]) ? std::cout << "EAX bit 26: " << eaxBits[27] << ": [SUPPORTED] Linear Address Masking - (lam)" << endl : std::cout << "EAX bit 26: " << eaxBits[26] << ": [UNSUPPORTED] Linear Address Masking - (lam)" << endl;
	(eaxBits[27]) ? std::cout << "EAX bit 27: " << eaxBits[28] << ": [SUPPORTED] RDMSRLIST and WRMSRLIST instructions, and the IA32_BARRIER (02Fh) MSR - (msrlist)" << endl : std::cout << "EAX bit 27: " << eaxBits[27] << ": [UNSUPPORTED] RDMSRLIST and WRMSRLIST instructions, and the IA32_BARRIER (02Fh) MSR - (msrlist)" << endl;
	(eaxBits[28]) ? std::cout << "EAX bit 28: " << eaxBits[29] << ": [SUPPORTED] Reserved" << endl : std::cout << "EAX bit 28: " << eaxBits[28] << ": [UNSUPPORTED] Reserved" << endl;
	(eaxBits[29]) ? std::cout << "EAX bit 29: " << eaxBits[29] << ": [SUPPORTED] Reserved" << endl : std::cout << "EAX bit 29: " << eaxBits[29] << ": [UNSUPPORTED] Reserved" << endl;
	(eaxBits[30]) ? std::cout << "EAX bit 30: " << eaxBits[30] << ": [SUPPORTED] If 1, supports INVD instruction execution prevention after BIOS Done. - (invd_­disable_­post_­bios_done)" << endl : std::cout << "EAX bit 30: " << eaxBits[30] << ": [UNSUPPORTED] If 1, supports INVD instruction execution prevention after BIOS Done. - (invd_­disable_­post_­bios_done)" << endl;
	...
	(ecxBits[20]) ? std::cout << "ECX bit 20: " << ecxBits[20] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 20: " << ecxBits[20] << ": [UNSUPPORTED] Reserved" << endl;
	(ecxBits[21]) ? std::cout << "ECX bit 21: " << ecxBits[21] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 21: " << ecxBits[21] << ": [UNSUPPORTED] Reserved" << endl;
	...
	(edxBits[0]) ? std::cout << "EDX bit 0: " << edxBits[0] << ": [SUPPORTED] Fast Store Forwarding Predictor disable supported. (SPEC_CTRL (MSR 48h) bit 7) - (psfd)" << endl : std::cout << "EDX bit 0: " << edxBits[0] << ": [UNSUPPORTED] Fast Store Forwarding Predictor disable supported. (SPEC_CTRL (MSR 48h) bit 7) - (psfd)" << endl;
	(edxBits[1]) ? std::cout << "EDX bit 1: " << edxBits[1] << ": [SUPPORTED] IPRED_DIS controls supported. (SPEC_CTRL bits 3 and 4) IPRED_DIS prevents instructions at an indirect branch target from speculatively executing until the branch target address is resolved. - (ipred_ctrl)" << endl : std::cout << "EDX bit 1: " << edxBits[1] << ": [UNSUPPORTED] IPRED_DIS controls supported. (SPEC_CTRL bits 3 and 4) IPRED_DIS prevents instructions at an indirect branch target from speculatively executing until the branch target address is resolved. - (ipred_ctrl)" << endl;
	(edxBits[2]) ? std::cout << "EDX bit 2: " << edxBits[2] << ": [SUPPORTED] RRSBA behavior disable supported. (SPEC_CTRL bits 5 and 6) - (rrsba_ctrl)" << endl : std::cout << "EDX bit 2: " << edxBits[2] << ": [UNSUPPORTED] RRSBA behavior disable supported. (SPEC_CTRL bits 5 and 6) - (rrsba_ctrl)" << endl;
	(edxBits[3]) ? std::cout << "EDX bit 3: " << edxBits[3] << ": [SUPPORTED] Data Dependent Prefetcher disable supported. (SPEC_CTRL bit 8) - (ddpd_u)" << endl : std::cout << "EDX bit 3: " << edxBits[3] << ": [UNSUPPORTED] Data Dependent Prefetcher disable supported. (SPEC_CTRL bit 8) - (ddpd_u)" << endl;
	(edxBits[4]) ? std::cout << "EDX bit 4: " << edxBits[4] << ": [SUPPORTED] BHI_DIS_S behavior[128] enable supported. (SPEC_CTRL bit 10) BHI_DIS_S prevents predicted targets of indirect branches executed in ring 0 / 1 / 2 from being selected based on branch history from branches executed in ring 3. - (bhi_ctrl)" << endl : std::cout << "EDX bit 4: " << edxBits[4] << ": [UNSUPPORTED] BHI_DIS_S behavior[128] enable supported. (SPEC_CTRL bit 10) BHI_DIS_S prevents predicted targets of indirect branches executed in ring 0 / 1 / 2 from being selected based on branch history from branches executed in ring 3. - (bhi_ctrl)" << endl;
	(edxBits[5]) ? std::cout << "EDX bit 5: " << edxBits[5] << ": [SUPPORTED] If set, the processor does not exhibit MXCSR configuration dependent timing. - (mcdt_no)" << endl : std::cout << "EDX bit 5: " << edxBits[5] << ": [UNSUPPORTED] If set, the processor does not exhibit MXCSR configuration dependent timing. - (mcdt_no)" << endl;
	(edxBits[6]) ? std::cout << "EDX bit 6: " << edxBits[6] << ": [SUPPORTED] UC-lock disable feature (with UC-lock exceptions reported as #AC) supported. - (UC_LOCK_DISABLE)" << endl : std::cout << "EDX bit 6: " << edxBits[6] << ": [UNSUPPORTED] UC-lock disable feature (with UC-lock exceptions reported as #AC) supported. - (UC_LOCK_­DISABLE)" << endl;
	(edxBits[7]) ? std::cout << "EDX bit 7: " << edxBits[7] << ": [SUPPORTED] If set, indicates that the MONITOR/UMONITOR instructions are not affected by performance/power issues caused by the instructions exceeding the capacity of an internal monitor tracking table. - (monitor_­mitg_no)" << endl : std::cout << "EDX bit 7: " << edxBits[7] << ": [UNSUPPORTED] If set, indicates that the MONITOR/UMONITOR instructions are not affected by performance/power issues caused by the instructions exceeding the capacity of an internal monitor tracking table. - (monitor_­mitg_no)" << endl;
	...
	if (0 == cpuInfo[2])
	{
		...
		std::cout << "EAX=0xD: [XSAVE Features]:" << endl;
		std::cout << "EAX=0xD: EBX: Maximum size (in bytes) of XSAVE save area for the set of state-components currently set in XCR0. = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[1], 8) << endl;
		std::cout << "EAX=0xD: ECX: Maximum size (in bytes) of XSAVE save area if all state-components supported by XCR0 on this CPU were enabled at the same time. = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[2], 8) << endl;
		std::cout << "EAX=0xD: EDX:EAX: 64-bit bitmap of state-components supported by XCR0 on this CPU. = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[3], 8) << "0x" << ZeroPadNumber(cpuInfo[0], 8) << endl;
		std::cout << "EAX=0xD: EDX:EAX: 64-bit bitmap of state-components supported by XCR0 on this CPU. = " << cpuInfo[3] << ":" << cpuInfo[0] << endl;
		std::cout << endl;
	}
	else if (1 == cpuInfo[2])
	{
		// CPUID EAX=0Dh,ECX=1: XSAVE extended features 
		std::cout << "EAX=0xD: [XSAVE Extended Features]:" << endl;
		std::cout << "EAX=0xD: EBX: Size (in bytes) of XSAVE area containing all the state-components currently set in XCR0 and IA32_XSS combined.  = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[1], 8) << endl;
		std::cout << "EAX=0xD: EDX:ECX: 64-bit bitmap of state-components supported by IA32_XSS on this CPU. = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[3], 8) << "0x" << ZeroPadNumber(cpuInfo[2], 8) << endl;
		std::cout << "EAX=0xD: EDX:ECX: 64-bit bitmap of state-components supported by IA32_XSS on this CPU. = " << cpuInfo[3] << ":" << cpuInfo[2] << endl;

		// CPUID EAX=0Dh,ECX=1: XSAVE feature flags in EAX
		std::cout << "EAX=0xD: [XSAVE Feature Flags]:" << endl;
		(eaxBits[0]) ? std::cout << "EAX bit 0: " << eaxBits[0] << ": [SUPPORTED] XSAVEOPT instruction: save state-components that have been modified since last XRSTOR - (xsaveopt)" << endl : std::cout << "EAX bit 0: " << eaxBits[0] << ": [UNSUPPORTED] XSAVEOPT instruction: save state-components that have been modified since last XRSTOR - (xsaveopt)" << endl;
		(eaxBits[1]) ? std::cout << "EAX bit 1: " << eaxBits[1] << ": [SUPPORTED] XSAVEC instruction: save/restore state with compaction - (xsavec)" << endl : std::cout << "EAX bit 1: " << eaxBits[1] << ": [UNSUPPORTED] XSAVEC instruction: save/restore state with compaction - (xsavec)" << endl;
		(eaxBits[2]) ? std::cout << "EAX bit 2: " << eaxBits[2] << ": [SUPPORTED] XGETBV with ECX=1 support - (xgetbv_ecx1)" << endl : std::cout << "EAX bit 2: " << eaxBits[2] << ": [UNSUPPORTED] XGETBV with ECX=1 support - (xgetbv_ecx1)" << endl;
		(eaxBits[3]) ? std::cout << "EAX bit 3: " << eaxBits[3] << ": [SUPPORTED] XSAVES and XRSTORS instructions and IA32_XSS MSR: save/restore state with compaction, including supervisor state. - (xss)" << endl : std::cout << "EAX bit 3: " << eaxBits[3] << ": [UNSUPPORTED] XSAVES and XRSTORS instructions and IA32_XSS MSR: save/restore state with compaction, including supervisor state. - (xss)" << endl;
		(eaxBits[4]) ? std::cout << "EAX bit 4: " << eaxBits[4] << ": [SUPPORTED] XFD (Extended Feature Disable) supported - (xfd)" << endl : std::cout << "EAX bit 4: " << eaxBits[4] << ": [UNSUPPORTED] XFD (Extended Feature Disable) supported - (xfd)" << endl;
	...
	else if (2 <= cpuInfo[2])
	{
		...
		std::cout << "EAX=0xD: EAX: Size (in bytes) of state-component = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[0], 32) << endl;
		std::cout << endl;
		std::cout << "EAX=0xD: EBX: Offset (in bytes) of state-component from the start of the XSAVE/XRSTOR save area (This offset is 0 for supervisor state - components, since these can only be saved / restored with the XSAVES / XRSTORS instructions, which always use compacting.) = " << std::hex << "0x" << ZeroPadNumber(cpuInfo[1], 32) << endl;
		std::cout << endl;
		(ecxBits[0]) ? std::cout << "ECX bit 0: User/supervisor state-component: " << ecxBits[0] << ": 1 = supervisor-state (enabled through IA32_XSS)" << endl : std::cout << "ECX bit 0: " << ecxBits[0] << ": 0 = user-state (enabled through XCR0)" << endl;
		std::cout << "ECX bit 1: 64-byte alignment enable when state save compaction is used. If this bit is set for a state-component, then, when storing state with compaction, padding will be inserted between the preceding state-component and this state-component as needed to provide 64-byte alignment. If this bit is not set, the state-component will be stored directly after the preceding one.: " << ecxBits[1] << endl;
		(ecxBits[2]) ? std::cout << "ECX bit 2: " << ecxBits[2] << ": [SUPPORTED] XFD Faulting supported for state-component." << endl : std::cout << "ECX bit 2: " << ecxBits[2] << ": [UNSUPPORTED] XFD Faulting supported for state-component." << endl;
		(ecxBits[3]) ? std::cout << "ECX bit 3: " << ecxBits[3] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 3: " << ecxBits[3] << ": [UNSUPPORTED] Reserved" << endl;
	...
	ecxBits = bitset<32>(cpuInfo[2]);
	edxBits = bitset<32>(cpuInfo[3]);
	std::cout << "EAX=0x12: ECX=0x0 [SGX Capabilities]:" << endl;
	...
	__cpuidex(cpuInfo, 0x12, 1);
	eaxBits = bitset<32>(cpuInfo[0]);
	ebxBits = bitset<32>(cpuInfo[1]);
	ecxBits = bitset<32>(cpuInfo[2]);
	edxBits = bitset<32>(cpuInfo[3]);
	std::cout << "EAX=0x12: ECX=0x1 [SGX Capabilities]:" << endl;
	std::cout << "EAX=0x12: [EAX] = " << eaxBits << endl;
	std::cout << "EAX=0x12: [EBX] = " << ebxBits << endl;
	std::cout << "EAX=0x12: [ECX] = " << ecxBits << endl;
	std::cout << "EAX=0x12: [EDX] = " << edxBits << endl;
	...
	__cpuidex(cpuInfo, 0x12, 2);
	eaxBits = bitset<32>(cpuInfo[0]);
	ebxBits = bitset<32>(cpuInfo[1]);
	ecxBits = bitset<32>(cpuInfo[2]);
	edxBits = bitset<32>(cpuInfo[3]);
	std::cout << "EAX=0x12: ECX=0x2 [SGX Capabilities]:" << endl;
	std::cout << "EAX=0x12: [EAX] = " << eaxBits << endl;
	std::cout << "EAX=0x12: [EBX] = " << ebxBits << endl;
	std::cout << "EAX=0x12: [ECX] = " << ecxBits << endl;
	std::cout << "EAX=0x12: [EDX] = " << edxBits << endl;
	...
	(ebxBits[0]) ? std::cout << "EBX bit 0: " << ebxBits[0] << ": [SUPPORTED] CR3 filtering supported - (cr3_filter)" << endl : std::cout << "EBX bit 0: " << ebxBits[0] << ": [UNSUPPORTED] CR3 filtering supported - (cr3_filter)" << endl;
	(ebxBits[1]) ? std::cout << "EBX bit 1: " << ebxBits[1] << ": [SUPPORTED] Configurable PSB (Packet Stream Boundary) packet rate and Cycle-Accurate Mode (CYC packets) supported - (cyc_acc)" << endl : std::cout << "EBX bit 1: " << ebxBits[1] << ": [UNSUPPORTED] Configurable PSB (Packet Stream Boundary) packet rate and Cycle-Accurate Mode (CYC packets) supported - (cyc_acc)" << endl;
	(ebxBits[2]) ? std::cout << "EBX bit 2: " << ebxBits[2] << ": [SUPPORTED] IP filtering, TraceStop filtering and preservation of PT MSRs across warm reset supported - (ip_filter)" << endl : std::cout << "EBX bit 2: " << ebxBits[2] << ": [UNSUPPORTED] IP filtering, TraceStop filtering and preservation of PT MSRs across warm reset supported - (ip_filter)" << endl;
	(ebxBits[3]) ? std::cout << "EBX bit 3: " << ebxBits[3] << ": [SUPPORTED] MTC (Mini Time Counter) timing packets supported, and suppression of COFI (Change of Flow Instructions) packets supported. - (mtc)" << endl : std::cout << "EBX bit 3: " << ebxBits[3] << ": [UNSUPPORTED] MTC (Mini Time Counter) timing packets supported, and suppression of COFI (Change of Flow Instructions) packets supported. - (mtc)" << endl;
	(ebxBits[4]) ? std::cout << "EBX bit 4: " << ebxBits[4] << ": [SUPPORTED] PTWRITE instruction supported - (ptwrite)" << endl : std::cout << "EBX bit 4: " << ebxBits[4] << ": [UNSUPPORTED] PTWRITE instruction supported - (ptwrite)" << endl;
	(ebxBits[5]) ? std::cout << "EBX bit 5: " << ebxBits[5] << ": [SUPPORTED] Power Event Trace supported - (pwr_evt_­trace)" << endl : std::cout << "EBX bit 5: " << ebxBits[5] << ": [UNSUPPORTED] Power Event Trace supported - (pwr_evt_­trace)" << endl;
	(ebxBits[6]) ? std::cout << "EBX bit 6: " << ebxBits[6] << ": [SUPPORTED] Preservation of PSB and PMI (performance monitoring interrupt) supported - (pmi_preserve)" << endl : std::cout << "EBX bit 6: " << ebxBits[6] << ": [UNSUPPORTED] Preservation of PSB and PMI (performance monitoring interrupt) supported - (pmi_preserve)" << endl;
	(ebxBits[7]) ? std::cout << "EBX bit 7: " << ebxBits[7] << ": [SUPPORTED] Event Trace packet generation supported (event_trace)" << endl : std::cout << "EBX bit 7: " << ebxBits[7] << ": [UNSUPPORTED] Event Trace packet generation supported (event_trace)" << endl;
	(ebxBits[8]) ? std::cout << "EBX bit 8: " << ebxBits[8] << ": [SUPPORTED] TNT (Branch Taken-Not-Taken) packet generation disable supported. - (tnt_dis)" << endl : std::cout << "EBX bit 8: " << ebxBits[8] << ": [UNSUPPORTED] TNT (Branch Taken-Not-Taken) packet generation disable supported. - (tnt_dis)" << endl;
	(ebxBits[9]) ? std::cout << "EBX bit 9: " << ebxBits[9] << ": [SUPPORTED] PTTT (Processor Trace Trigger Tracing) supported - (PTTT)" << endl : std::cout << "EBX bit 9: " << ebxBits[9] << ": [UNSUPPORTED] PTTT (Processor Trace Trigger Tracing) supported - (PTTT)" << endl;
	(ebxBits[10]) ? std::cout << "EBX bit 10: " << ebxBits[10] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 10: " << ebxBits[10] << ": [UNSUPPORTED] Reserved" << endl;
	(ebxBits[11]) ? std::cout << "EBX bit 11: " << ebxBits[11] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 11: " << ebxBits[11] << ": [UNSUPPORTED] Reserved" << endl;
	(ebxBits[12]) ? std::cout << "EBX bit 12: " << ebxBits[12] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 12: " << ebxBits[12] << ": [UNSUPPORTED] Reserved" << endl;
	(ebxBits[13]) ? std::cout << "EBX bit 13: " << ebxBits[13] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 13: " << ebxBits[13] << ": [UNSUPPORTED] Reserved" << endl;
	...
	(ecxBits[0]) ? std::cout << "ECX bit 0: " << ecxBits[0] << ": [SUPPORTED] ToPA (Table of Physical Addresses) output mechanism for trace packets supported - (topaout)" << endl : std::cout << "ECX bit 0: " << ecxBits[0] << ": [UNSUPPORTED] ToPA (Table of Physical Addresses) output mechanism for trace packets supported - (topaout)" << endl;
	(ecxBits[1]) ? std::cout << "ECX bit 1: " << ecxBits[1] << ": [SUPPORTED] ToPA tables can contain hold multiple output entries - (mentry)" << endl : std::cout << "ECX bit 1: " << ecxBits[1] << ": [UNSUPPORTED] ToPA tables can contain hold multiple output entries - (mentry)" << endl;
	(ecxBits[2]) ? std::cout << "ECX bit 2: " << ecxBits[2] << ": [SUPPORTED] Single-Range Output scheme supported - (sngl_rng_out)" << endl : std::cout << "ECX bit 2: " << ecxBits[2] << ": [UNSUPPORTED] Single-Range Output scheme supported - (sngl_rng_out)" << endl;
	(ecxBits[3]) ? std::cout << "ECX bit 3: " << ecxBits[3] << ": [SUPPORTED] Output to Trace Transport subsystem supported - (trace_transport_subsystem)" << endl : std::cout << "ECX bit 3: " << ecxBits[3] << ": [UNSUPPORTED] Output to Trace Transport subsystem supported - (trace_transport_subsystem)" << endl;
	(ecxBits[4]) ? std::cout << "ECX bit 4: " << ecxBits[4] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 4: " << ecxBits[4] << ": [UNSUPPORTED] Reserved" << endl;
	(ecxBits[5]) ? std::cout << "ECX bit 5: " << ecxBits[5] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 5: " << ecxBits[5] << ": [UNSUPPORTED] Reserved" << endl;
	(ecxBits[6]) ? std::cout << "ECX bit 6: " << ecxBits[6] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 6: " << ecxBits[6] << ": [UNSUPPORTED] Reserved" << endl;
	(ecxBits[7]) ? std::cout << "ECX bit 7: " << ecxBits[7] << ": [SUPPORTED] Reserved" << endl : std::cout << "ECX bit 7: " << ecxBits[7] << ": [UNSUPPORTED] Reserved" << endl;
	...
	std::cout << "EAX=0x14: Trigger actions TRACE_PAUSE and TRACE_RESUME supported = (TRIGGER_PAUSE): ECX Bits 1 = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[0], 1, 1), 1) << endl;
	...
	std::cout << endl;
	std::cout << "EAX=0x20000000: [EAX] Highest Xeon Phi Function Implemented = 0x" << std::hex << cpuInfo[0] << endl;
	std::cout << endl;
	...
	ecxBits = bitset<32>(cpuInfo[2]);
	edxBits = bitset<32>(cpuInfo[3]);
	std::cout << "EAX=0x40000000-4FFFFFFFh: [Reserved for Hypervisors]:" << endl;
	...
	std::cout << endl;
	std::cout << "EAX=0x80000000: [EAX] Highest Extended Function Implemented = 0x" << std::hex << pbsFeatureAvailable << endl;
	std::cout << endl;
	...
	std::cout << "EAX=0x80000001: Feature bits in ECX (AMD feature flags):" << endl;
	(ecxBits[0]) ? std::cout << "ECX bit 0: " << ecxBits[0] << ": [SUPPORTED] Onboard x87 FPU - (fpu)" << endl : std::cout << "ECX bit 0: " << ecxBits[0] << ": [UNSUPPORTED] Onboard x87 FPU - (fpu)" << endl;
	(ecxBits[1]) ? std::cout << "ECX bit 1: " << ecxBits[1] << ": [SUPPORTED] Virtual mode extensions (VIF) - (vme)" << endl : std::cout << "ECX bit 1: " << ecxBits[1] << ": [UNSUPPORTED] Virtual mode extensions (VIF) - (vme)" << endl;
	(ecxBits[2]) ? std::cout << "ECX bit 2: " << ecxBits[2] << ": [SUPPORTED] Debugging extensions (CR4 bit 3) - (de)" << endl : std::cout << "ECX bit 2: " << ecxBits[2] << ": [UNSUPPORTED] Debugging extensions (CR4 bit 3) - (de)" << endl;
	(ecxBits[3]) ? std::cout << "ECX bit 3: " << ecxBits[3] << ": [SUPPORTED] Page Size Extension - (pse)" << endl : std::cout << "ECX bit 3: " << ecxBits[3] << ": [UNSUPPORTED] Page Size Extension - (pse)" << endl;
	(ecxBits[4]) ? std::cout << "ECX bit 4: " << ecxBits[4] << ": [SUPPORTED] Time Stamp Counter - (tsc)" << endl : std::cout << "ECX bit 4: " << ecxBits[4] << ": [UNSUPPORTED] Time Stamp Counter - (tsc)" << endl;
	(ecxBits[5]) ? std::cout << "ECX bit 5: " << ecxBits[5] << ": [SUPPORTED] Model-specific registers - (msr)" << endl : std::cout << "ECX bit 5: " << ecxBits[5] << ": [UNSUPPORTED] Model-specific registers - (msr)" << endl;
	(ecxBits[6]) ? std::cout << "ECX bit 6: " << ecxBits[6] << ": [SUPPORTED] Physical Address Extension - (pae)" << endl : std::cout << "ECX bit 6: " << ecxBits[6] << ": [UNSUPPORTED] Physical Address Extension - (pae)" << endl;
	(ecxBits[7]) ? std::cout << "ECX bit 7: " << ecxBits[7] << ": [SUPPORTED] Machine Check Exception - (mce)" << endl : std::cout << "ECX bit 7: " << ecxBits[7] << ": [UNSUPPORTED] Machine Check Exception - (mce)" << endl;
	(ecxBits[8]) ? std::cout << "ECX bit 8: " << ecxBits[8] << ": [SUPPORTED] CMPXCHG8B (compare-and-swap) instruction - (cx8)" << endl : std::cout << "ECX bit 8: " << ecxBits[8] << ": [UNSUPPORTED] CMPXCHG8B (compare-and-swap) instruction - (cx8)" << endl;
	(ecxBits[9]) ? std::cout << "ECX bit 9: " << ecxBits[9] << ": [SUPPORTED] Onboard Advanced Programmable Interrupt Controller - (apic)" << endl : std::cout << "ECX bit 9: " << ecxBits[9] << ": [UNSUPPORTED] Onboard Advanced Programmable Interrupt Controller - (apic)" << endl;
	(ecxBits[10]) ? std::cout << "ECX bit 10: " << ecxBits[10] << ": [SUPPORTED] (SYSCALL/SYSRET, K6 only) - (syscall)" << endl : std::cout << "ECX bit 10: " << ecxBits[10] << ": [UNSUPPORTED] (SYSCALL/SYSRET, K6 only) - (syscall)" << endl;
	(ecxBits[11]) ? std::cout << "ECX bit 11: " << ecxBits[11] << ": [SUPPORTED] SYSCALL and SYSRET instructions - (syscall)" << endl : std::cout << "ECX bit 11: " << ecxBits[11] << ": [UNSUPPORTED] SYSCALL and SYSRET instructions - (syscall)" << endl;
	(ecxBits[12]) ? std::cout << "ECX bit 12: " << ecxBits[12] << ": [SUPPORTED] Memory Type Range Registers - (mtrr)" << endl : std::cout << "ECX bit 12: " << ecxBits[12] << ": [UNSUPPORTED] Memory Type Range Registers - (mtrr)" << endl;
	(ecxBits[13]) ? std::cout << "ECX bit 13: " << ecxBits[13] << ": [SUPPORTED] Page Global Enable bit in CR4 - (pge)" << endl : std::cout << "ECX bit 13: " << ecxBits[13] << ": [UNSUPPORTED] Page Global Enable bit in CR4 - (pge)" << endl;
	(ecxBits[14]) ? std::cout << "ECX bit 14: " << ecxBits[14] << ": [SUPPORTED] Machine check architecture - (mca)" << endl : std::cout << "ECX bit 14: " << ecxBits[14] << ": [UNSUPPORTED] Machine check architecture - (mca)" << endl;
	(ecxBits[15]) ? std::cout << "ECX bit 15: " << ecxBits[15] << ": [SUPPORTED] Conditional move and FCMOV instructions - (cmov)" << endl : std::cout << "ECX bit 15: " << ecxBits[15] << ": [UNSUPPORTED] Conditional move and FCMOV instructions - (cmov)" << endl;
	(ecxBits[16]) ? std::cout << "ECX bit 16: " << ecxBits[16] << ": [SUPPORTED] Page Attribute Table - (pat)" << endl : std::cout << "ECX bit 16: " << ecxBits[16] << ": [UNSUPPORTED] Page Attribute Table - (pat)" << endl;
	(ecxBits[17]) ? std::cout << "ECX bit 17: " << ecxBits[17] << ": [SUPPORTED] 36-bit page size extension - (pse36)" << endl : std::cout << "ECX bit 17: " << ecxBits[17] << ": [UNSUPPORTED] 36-bit page size extension - (pse36)" << endl;
	(ecxBits[18]) ? std::cout << "ECX bit 18: " << ecxBits[18] << ": [SUPPORTED] (Processor supports ECC; K7 only) - (ecc)" << endl : std::cout << "ECX bit 18: " << ecxBits[18] << ": [UNSUPPORTED] (Processor supports ECC; K7 only) - (ecc)" << endl;
	(ecxBits[19]) ? std::cout << "ECX bit 19: " << ecxBits[19] << ": [SUPPORTED] \"Athlon MP\" / \"Sempron\" CPU brand identification - (ecc)" << endl : std::cout << "ECX bit 19: " << ecxBits[19] << ": [UNSUPPORTED] \"Athlon MP\" / \"Sempron\" CPU brand identification - (ecc)" << endl;
	(ecxBits[20]) ? std::cout << "ECX bit 20: " << ecxBits[20] << ": [SUPPORTED] NX bit (page-table no-execute bit) - (nx)" << endl : std::cout << "ECX bit 20: " << ecxBits[20] << ": [UNSUPPORTED] NX bit (page-table no-execute bit) - (nx)" << endl;
	(ecxBits[21]) ? std::cout << "ECX bit 21: " << ecxBits[21] << ": [SUPPORTED] ? - (sem)" << endl : std::cout << "ECX bit 21: " << ecxBits[21] << ": [UNSUPPORTED] ? - (sem)" << endl;
	(ecxBits[22]) ? std::cout << "ECX bit 22: " << ecxBits[22] << ": [SUPPORTED] Extended MMX (non-XMM subset of SSE1) - (mmxext)" << endl : std::cout << "ECX bit 22: " << ecxBits[22] << ": [UNSUPPORTED] Extended MMX (non-XMM subset of SSE1) - (mmxext)" << endl;
	(ecxBits[23]) ? std::cout << "ECX bit 23: " << ecxBits[23] << ": [SUPPORTED] MMX instructions - (mmx)" << endl : std::cout << "ECX bit 23: " << ecxBits[23] << ": [UNSUPPORTED] MMX instructions - (mmx)" << endl;
	(ecxBits[24]) ? std::cout << "ECX bit 24: " << ecxBits[24] << ": [SUPPORTED] FXSAVE, FXRSTOR instructions, CR4 bit 9 - (fxsr)" << endl : std::cout << "ECX bit 24: " << ecxBits[24] << ": [UNSUPPORTED] FXSAVE, FXRSTOR instructions, CR4 bit 9 - (fxsr)" << endl;
	(ecxBits[25]) ? std::cout << "ECX bit 25: " << ecxBits[25] << ": [SUPPORTED] FXSAVE/FXRSTOR optimizations - (fxsr_opt)" << endl : std::cout << "ECX bit 25: " << ecxBits[25] << ": [UNSUPPORTED] FXSAVE/FXRSTOR optimizations - (fxsr_opt)" << endl;
	(ecxBits[26]) ? std::cout << "ECX bit 26: " << ecxBits[26] << ": [SUPPORTED] Gibibyte pages - (pdpe1gb)" << endl : std::cout << "ECX bit 26: " << ecxBits[26] << ": [UNSUPPORTED] Gibibyte pages - (pdpe1gb)" << endl;
	(ecxBits[27]) ? std::cout << "ECX bit 27: " << ecxBits[27] << ": [SUPPORTED] RDTSCP instruction - (rdtscp)" << endl : std::cout << "ECX bit 27: " << ecxBits[27] << ": [UNSUPPORTED] RDTSCP instruction - (rdtscp)" << endl;
	(ecxBits[28]) ? std::cout << "ECX bit 28: " << ecxBits[28] << ": [SUPPORTED] (REX prefix available in 32-bit mode; early K8 only) - (rex32)" << endl : std::cout << "ECX bit 28: " << ecxBits[28] << ": [UNSUPPORTED] (REX prefix available in 32-bit mode; early K8 only) - (rex32)" << endl;
	(ecxBits[29]) ? std::cout << "ECX bit 29: " << ecxBits[29] << ": [SUPPORTED] Long mode (x86-64) - (lm)" << endl : std::cout << "ECX bit 29: " << ecxBits[29] << ": [UNSUPPORTED] Long mode (x86-64) - (lm)" << endl;
	(ecxBits[30]) ? std::cout << "ECX bit 30: " << ecxBits[30] << ": [SUPPORTED] Extended 3DNow! - (3dnowext)" << endl : std::cout << "ECX bit 30: " << ecxBits[30] << ": [UNSUPPORTED] Extended 3DNow! - (3dnowext)" << endl;
	(ecxBits[31]) ? std::cout << "ECX bit 31: " << ecxBits[31] << ": [SUPPORTED] 3DNow! - (3dnow)" << endl : std::cout << "ECX bit 31: " << ecxBits[31] << ": [UNSUPPORTED] 3DNow! - (3dnow)" << endl;
	std::cout << endl;

	std::cout << "EAX=0x80000001: Feature bits in EDX (AMD feature flags):" << endl;
	(edxBits[0]) ? std::cout << "EDX bit 0: " << edxBits[0] << ": [SUPPORTED] LAHF/SAHF in long mode - (lahf_lm)" << endl : std::cout << "EDX bit 0: " << edxBits[0] << ": [UNSUPPORTED] LAHF/SAHF in long mode - (lahf_lm)" << endl;
	(edxBits[1]) ? std::cout << "EDX bit 1: " << edxBits[1] << ": [SUPPORTED] Hyperthreading not valid - (cmp_legacy)" << endl : std::cout << "EDX bit 1: " << edxBits[1] << ": [UNSUPPORTED] Hyperthreading not valid - (cmp_legacy)" << endl;
	(edxBits[2]) ? std::cout << "EDX bit 2: " << edxBits[2] << ": [SUPPORTED] Secure Virtual Machine - (svm)" << endl : std::cout << "EDX bit 2: " << edxBits[2] << ": [UNSUPPORTED] Secure Virtual Machine - (svm)" << endl;
	(edxBits[3]) ? std::cout << "EDX bit 3: " << edxBits[3] << ": [SUPPORTED] Extended APIC space - (extapic)" << endl : std::cout << "EDX bit 3: " << edxBits[3] << ": [UNSUPPORTED] Extended APIC space - (extapic)" << endl;
	(edxBits[4]) ? std::cout << "EDX bit 4: " << edxBits[4] << ": [SUPPORTED] CR8 in 32-bit mode - (cr8_legacy)" << endl : std::cout << "EDX bit 4: " << edxBits[4] << ": [UNSUPPORTED] CR8 in 32-bit mode - (cr8_legacy)" << endl;
	(edxBits[5]) ? std::cout << "EDX bit 5: " << edxBits[5] << ": [SUPPORTED] Advanced bit manipulation (LZCNT and POPCNT) - (abm/lzcnt)" << endl : std::cout << "EDX bit 5: " << edxBits[5] << ": [UNSUPPORTED] Advanced bit manipulation (LZCNT and POPCNT) - (abm/lzcnt)" << endl;
	(edxBits[6]) ? std::cout << "EDX bit 6: " << edxBits[6] << ": [SUPPORTED] SSE4a - (sse4a)" << endl : std::cout << "EDX bit 6: " << edxBits[6] << ": [UNSUPPORTED] SSE4a - (sse4a)" << endl;
	(edxBits[7]) ? std::cout << "EDX bit 7: " << edxBits[7] << ": [SUPPORTED] Misaligned SSE mode - (misalignsse)" << endl : std::cout << "EDX bit 7: " << edxBits[7] << ": [UNSUPPORTED] Misaligned SSE mode - (misalignsse)" << endl;
	(edxBits[8]) ? std::cout << "EDX bit 8: " << edxBits[8] << ": [SUPPORTED] PREFETCH and PREFETCHW instructions - (3dnowprefetch)" << endl : std::cout << "EDX bit 8: " << edxBits[8] << ": [UNSUPPORTED] PREFETCH and PREFETCHW instructions - (3dnowprefetch)" << endl;
	(edxBits[9]) ? std::cout << "EDX bit 9: " << edxBits[9] << ": [SUPPORTED] OS Visible Workaround - (osvw)" << endl : std::cout << "EDX bit 9: " << edxBits[9] << ": [UNSUPPORTED] OS Visible Workaround - (osvw)" << endl;
	(edxBits[10]) ? std::cout << "EDX bit 10: " << edxBits[10] << ": [SUPPORTED] Instruction Based Sampling - (ibs)" << endl : std::cout << "EDX bit 10: " << edxBits[10] << ": [UNSUPPORTED] Instruction Based Sampling - (ibs)" << endl;
	(edxBits[11]) ? std::cout << "EDX bit 11: " << edxBits[11] << ": [SUPPORTED] XOP instruction set - (xop)" << endl : std::cout << "EDX bit 11: " << edxBits[11] << ": [UNSUPPORTED] XOP instruction set - (xop)" << endl;
	(edxBits[12]) ? std::cout << "EDX bit 12: " << edxBits[12] << ": [SUPPORTED] SKINIT and STGI instructions - (skinit)" << endl : std::cout << "EDX bit 12: " << edxBits[12] << ": [UNSUPPORTED] SKINIT and STGI instructions - (skinit)" << endl;
	(edxBits[13]) ? std::cout << "EDX bit 13: " << edxBits[13] << ": [SUPPORTED] Watchdog timer - (wdt)" << endl : std::cout << "EDX bit 13: " << edxBits[13] << ": [UNSUPPORTED] Watchdog timer - (wdt)" << endl;
	(edxBits[14]) ? std::cout << "EDX bit 14: " << edxBits[14] << ": [SUPPORTED] (TBM0 instruction support) - (tbm0)" << endl : std::cout << "EDX bit 14: " << edxBits[14] << ": [UNSUPPORTED] (TBM0 instruction support) - (tbm0)" << endl;
	(edxBits[15]) ? std::cout << "EDX bit 15: " << edxBits[15] << ": [SUPPORTED] Lightweight Profiling - (lwp)" << endl : std::cout << "EDX bit 15: " << edxBits[15] << ": [UNSUPPORTED] Lightweight Profiling - (lwp)" << endl;
	(edxBits[16]) ? std::cout << "EDX bit 16: " << edxBits[16] << ": [SUPPORTED] 4-operand fused multiply-add instructions - (fma4)" << endl : std::cout << "EDX bit 16: " << edxBits[16] << ": [UNSUPPORTED] 4-operand fused multiply-add instructions - (fma4)" << endl;
	(edxBits[17]) ? std::cout << "EDX bit 17: " << edxBits[17] << ": [SUPPORTED] Translation Cache Extension - (tce)" << endl : std::cout << "EDX bit 17: " << edxBits[17] << ": [UNSUPPORTED] Translation Cache Extension - (tce)" << endl;
	(edxBits[18]) ? std::cout << "EDX bit 18: " << edxBits[18] << ": [SUPPORTED] (XOP-prefix forms of the FP16↔FP32 conversion instructions VCVTPS2PH and VCVTPH2PS) - (cvt16)" << endl : std::cout << "EDX bit 18: " << edxBits[18] << ": [UNSUPPORTED] (XOP-prefix forms of the FP16↔FP32 conversion instructions VCVTPS2PH and VCVTPH2PS) - (cvt16)" << endl;
	(edxBits[19]) ? std::cout << "EDX bit 19: " << edxBits[19] << ": [SUPPORTED] NodeID MSR (C001_100C) - (nodeid_msr)" << endl : std::cout << "EDX bit 19: " << edxBits[19] << ": [UNSUPPORTED] NodeID MSR (C001_100C) - (nodeid_msr)" << endl;
	(edxBits[20]) ? std::cout << "EDX bit 20: " << edxBits[20] << ": [SUPPORTED] Reserved" << endl : std::cout << "EDX bit 20: " << edxBits[20] << ": [UNSUPPORTED] Reserved" << endl;
	(edxBits[21]) ? std::cout << "EDX bit 21: " << edxBits[21] << ": [SUPPORTED] Trailing Bit Manipulation - (tbm)" << endl : std::cout << "EDX bit 21: " << edxBits[21] << ": [UNSUPPORTED] Trailing Bit Manipulation - (tbm)" << endl;
	(edxBits[22]) ? std::cout << "EDX bit 22: " << edxBits[22] << ": [SUPPORTED] Topology Extensions (CPUID leaves 80000001D and 80000001E) - (topoext)" << endl : std::cout << "EDX bit 22: " << edxBits[22] << ": [UNSUPPORTED] Topology Extensions (CPUID leaves 80000001D and 80000001E) - (topoext)" << endl;
	(edxBits[23]) ? std::cout << "EDX bit 23: " << edxBits[23] << ": [SUPPORTED] Core performance counter extensions - (perfctr_core)" << endl : std::cout << "EDX bit 23: " << edxBits[23] << ": [UNSUPPORTED] Core performance counter extensions - (perfctr_core)" << endl;
	(edxBits[24]) ? std::cout << "EDX bit 24: " << edxBits[24] << ": [SUPPORTED] Northbridge performance counter extensions - (perfctr_nb)" << endl : std::cout << "EDX bit 24: " << edxBits[24] << ": [UNSUPPORTED] Northbridge performance counter extensions - (perfctr_nb)" << endl;
	(edxBits[25]) ? std::cout << "EDX bit 25: " << edxBits[25] << ": [SUPPORTED] (Streaming performance monitor architecture) - (StreamPerfMon)" << endl : std::cout << "EDX bit 25: " << edxBits[25] << ": [UNSUPPORTED] (Streaming performance monitor architecture) - (StreamPerfMon)" << endl;
	(edxBits[26]) ? std::cout << "EDX bit 26: " << edxBits[26] << ": [SUPPORTED] Data breakpoint extensions - (dbx)" << endl : std::cout << "EDX bit 26: " << edxBits[26] << ": [UNSUPPORTED] Data breakpoint extensions - (dbx)" << endl;
	(edxBits[27]) ? std::cout << "EDX bit 27: " << edxBits[27] << ": [SUPPORTED] Performance timestamp counter (PTSC) - (perftsc)" << endl : std::cout << "EDX bit 27: " << edxBits[27] << ": [UNSUPPORTED] Performance timestamp counter (PTSC) - (perftsc)" << endl;
	(edxBits[28]) ? std::cout << "EDX bit 28: " << edxBits[28] << ": [SUPPORTED] AMD Fam 15h/16h (Jaguar/Puma): L2I perf counter extensions AMD Fam ≥17h(Zen) : L3 perf counter extensions - (pcx_l2i/pcx_l3)" << endl : std::cout << "EDX bit 28: " << edxBits[28] << ": [UNSUPPORTED] AMD Fam 15h/16h (Jaguar/Puma): L2I perf counter extensions AMD Fam ≥17h(Zen) : L3 perf counter extensions - (pcx_l2i/pcx_l3)" << endl;
	(edxBits[29]) ? std::cout << "EDX bit 29: " << edxBits[29] << ": [SUPPORTED] MONITORX and MWAITX instructions - (monitorx)" << endl : std::cout << "EDX bit 29: " << edxBits[29] << ": [UNSUPPORTED] MONITORX and MWAITX instructions - (monitorx)" << endl;
	(edxBits[30]) ? std::cout << "EDX bit 30: " << edxBits[30] << ": [SUPPORTED] Address mask extension to 32 bits for instruction breakpoints - (addr_mask_ext)" << endl : std::cout << "EDX bit 30: " << edxBits[30] << ": [UNSUPPORTED] Address mask extension to 32 bits for instruction breakpoints - (addr_mask_ext)" << endl;
	(edxBits[31]) ? std::cout << "EDX bit 31: " << edxBits[31] << ": [SUPPORTED] Reserved" << endl : std::cout << "EDX bit 31: " << edxBits[31] << ": [UNSUPPORTED] Reserved" << endl;
	std::cout << endl;
	...
	std::cout << "EAX=0x80000005: [L1 Cache/TLB information in EAX,EBX,ECX,EDX]:" << endl;
	std::cout << "EAX=0x80000005: EAX Bits 7:0: Number of instruction TLB entries = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[0], 0, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EAX Bits 15:8: instruction TLB associativity = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[0], 8, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EAX Bits 23:16: Number of data TLB entries = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[0], 16, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EAX Bits 31:24: Data TLB associativity = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[0], 24, 8), 8) << endl;
	std::cout << endl;

	std::cout << "EAX=0x80000005: EBX Bits 7:0: Number of instruction TLB entries = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[1], 0, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EBX Bits 15:8: instruction TLB associativity = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[1], 8, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EBX Bits 23:16: Number of data TLB entries = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[1], 16, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EBX Bits 31:24: Data TLB associativity = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[1], 24, 8), 8) << endl;
	std::cout << endl;

	std::cout << "EAX=0x80000005: ECX Bits 7:0: Cache line size in bytes = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 0, 8), 8) << endl;
	std::cout << "EAX=0x80000005: ECX Bits 15:8: Number of cache lines per tag = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 8, 8), 8) << endl;
	std::cout << "EAX=0x80000005: ECX Bits 23:16: Cache associativity = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 16, 8), 8) << endl;
	std::cout << "EAX=0x80000005: ECX Bits 31:24: Cache size in kibibytes = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 24, 8), 8) << endl;
	std::cout << endl;

	std::cout << "EAX=0x80000005: EDX Bits 7:0: Cache line size in bytes = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 0, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EDX Bits 15:8: Number of cache lines per tag = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 8, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EDX Bits 23:16: Cache associativity = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 16, 8), 8) << endl;
	std::cout << "EAX=0x80000005: EDX Bits 31:24: Cache size in kibibytes = " << std::hex << "0x" << ZeroPadNumber(extractBits(cpuInfo[2], 24, 8), 8) << endl;
	std::cout << endl;
	...
	std::cout << "Line size: " << std::dec << lineSize << " B" << endl;
	std::cout << "Associativity type: " << std::dec << associativity << endl;
	std::cout << "Cache size: " << std::dec << cacheSize << " KiB" << endl;
	std::cout << endl;
	...
	(ebxBits[3]) ? std::cout << "EBX bit 3: " << ebxBits[3] << ": [SUPPORTED] Scalable MCA supported - (ScalableMca)" << endl : std::cout << "EBX bit 3: " << ebxBits[3] << ": [UNSUPPORTED] Scalable MCA supported - (ScalableMca)" << endl;
	(ebxBits[4]) ? std::cout << "EBX bit 4: " << ebxBits[4] << ": [SUPPORTED] Platform First Error Handling - (PFEH)" << endl : std::cout << "EBX bit 4: " << ebxBits[4] << ": [UNSUPPORTED] Platform First Error Handling - (PFEH)" << endl;
	(ebxBits[5]) ? std::cout << "EBX bit 5: " << ebxBits[5] << ": [SUPPORTED] Lightweight SMI - (LWSMI)" << endl : std::cout << "EBX bit 5: " << ebxBits[5] << ": [UNSUPPORTED] Lightweight SMI - (LWSMI)" << endl;
	(ebxBits[6]) ? std::cout << "EBX bit 6: " << ebxBits[6] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 6: " << ebxBits[6] << ": [UNSUPPORTED] Reserved" << endl;
	(ebxBits[7]) ? std::cout << "EBX bit 7: " << ebxBits[7] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 7: " << ebxBits[7] << ": [UNSUPPORTED] Reserved" << endl;
	(ebxBits[8]) ? std::cout << "EBX bit 8: " << ebxBits[8] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 8: " << ebxBits[8] << ": [UNSUPPORTED] Reserved" << endl;
	(ebxBits[9]) ? std::cout << "EBX bit 9: " << ebxBits[9] << ": [SUPPORTED] Reserved" << endl : std::cout << "EBX bit 9: " << ebxBits[9] << ": [UNSUPPORTED] Reserved" << endl;
	...
	(edxBits[3]) ? std::cout << "EDX bit 3: " << edxBits[3] << ": [SUPPORTED] THERMTRIP - (TTP)" << endl : std::cout << "EDX bit 3: " << edxBits[3] << ": [UNSUPPORTED] THERMTRIP - (TTP)" << endl;
	(edxBits[4]) ? std::cout << "EDX bit 4: " << edxBits[4] << ": [SUPPORTED] Hardware thermal control (HTC) supported - (TM)" << endl : std::cout << "EDX bit 4: " << edxBits[4] << ": [UNSUPPORTED] Hardware thermal control (HTC) supported - (TM)" << endl;
	(edxBits[5]) ? std::cout << "EDX bit 5: " << edxBits[5] << ": [SUPPORTED] Software thermal control (STC) supported - (STC)" << endl : std::cout << "EDX bit 5: " << edxBits[5] << ": [UNSUPPORTED] Software thermal control (STC) supported - (STC)" << endl;
	(edxBits[6]) ? std::cout << "EDX bit 6: " << edxBits[6] << ": [SUPPORTED] 100 MHz multiplier control - (100MHzSteps)" << endl : std::cout << "EDX bit 6: " << edxBits[6] << ": [UNSUPPORTED] 100 MHz multiplier control - (100MHzSteps)" << endl;
	(edxBits[7]) ? std::cout << "EDX bit 7: " << edxBits[7] << ": [SUPPORTED] Hardware P-state control (MSRs C001_0061 to C001_0063) - (HwPstate)" << endl : std::cout << "EDX bit 7: " << edxBits[7] << ": [UNSUPPORTED] Hardware P-state control (MSRs C001_0061 to C001_0063) - (HwPstate)" << endl;
	(edxBits[8]) ? std::cout << "EDX bit 8: " << edxBits[8] << ": [SUPPORTED] Invariant TSC - TSC (Time Stamp Counter) rate is guaranteed to be invariant across all P-states, C-states, and stop grant transitions. - (TscInvariant)" << endl : std::cout << "EDX bit 8: " << edxBits[8] << ": [UNSUPPORTED] Invariant TSC - TSC (Time Stamp Counter) rate is guaranteed to be invariant across all P-states, C-states, and stop grant transitions. - (TscInvariant)" << endl;
	(edxBits[9]) ? std::cout << "EDX bit 9: " << edxBits[9] << ": [SUPPORTED] Core Performance Boost - (CPB)" << endl : std::cout << "EDX bit 9: " << edxBits[9] << ": [UNSUPPORTED] Core Performance Boost - (CPB)" << endl;
	(edxBits[10]) ? std::cout << "EDX bit 10: " << edxBits[10] << ": [SUPPORTED] Read-only effective frequency interface (MSRs C000_00E7 and C000_00E8) - (EffFreqRO)" << endl : std::cout << "EDX bit 10: " << edxBits[10] << ": [UNSUPPORTED] Read-only effective frequency interface (MSRs C000_00E7 and C000_00E8) - (EffFreqRO)" << endl;
	(edxBits[11]) ? std::cout << "EDX bit 11: " << edxBits[11] << ": [SUPPORTED] Processor Feedback Interface supported - (ProcFeedbackInterface)" << endl : std::cout << "EDX bit 11: " << edxBits[11] << ": [UNSUPPORTED] Processor Feedback Interface supported - (ProcFeedbackInterface)" << endl;
	(edxBits[12]) ? std::cout << "EDX bit 12: " << edxBits[12] << ": [SUPPORTED] Processor power reporting interface supported - (ProcPowerReporting)" << endl : std::cout << "EDX bit 12: " << edxBits[12] << ": [UNSUPPORTED] Processor power reporting interface supported - (ProcPowerReporting)" << endl;
	(edxBits[13]) ? std::cout << "EDX bit 13: " << edxBits[13] << ": [SUPPORTED] Connected Standby - (ConnectedStandby)" << endl : std::cout << "EDX bit 13: " << edxBits[13] << ": [UNSUPPORTED] Connected Standby - (ConnectedStandby)" << endl;
	(edxBits[14]) ? std::cout << "EDX bit 14: " << edxBits[14] << ": [SUPPORTED] Running Average Power Limit - (RAPL)" << endl : std::cout << "EDX bit 14: " << edxBits[14] << ": [UNSUPPORTED] Running Average Power Limit - (RAPL)" << endl;
	(edxBits[15]) ? std::cout << "EDX bit 15: " << edxBits[15] << ": [SUPPORTED] Fast CPPC (Collaborative Processor Performance Control) supported - (FastCPPC)" << endl : std::cout << "EDX bit 15: " << edxBits[15] << ": [UNSUPPORTED] Fast CPPC (Collaborative Processor Performance Control) supported - (FastCPPC)" << endl;
	(edxBits[16]) ? std::cout << "EDX bit 16: " << edxBits[16] << ": [SUPPORTED] CPPC Performance Priority - (CppcPerfPriority)" << endl : std::cout << "EDX bit 16: " << edxBits[16] << ": [UNSUPPORTED] CPPC Performance Priority - (CppcPerfPriority)" << endl;
	(edxBits[17]) ? std::cout << "EDX bit 17: " << edxBits[17] << ": [SUPPORTED] Reserved" << endl : std::cout << "EDX bit 17: " << edxBits[17] << ": [UNSUPPORTED] Reserved" << endl;
	(edxBits[18]) ? std::cout << "EDX bit 18: " << edxBits[18] << ": [SUPPORTED] Reserved" << endl : std::cout << "EDX bit 18: " << edxBits[18] << ": [UNSUPPORTED] Reserved" << endl;
	(edxBits[19]) ? std::cout << "EDX bit 19: " << edxBits[19] << ": [SUPPORTED] Reserved" << endl : std::cout << "EDX bit 19: " << edxBits[19] << ": [UNSUPPORTED] Reserved" << endl;
	(edxBits[20]) ? std::cout << "EDX bit 20: " << edxBits[20] << ": [SUPPORTED] Reserved" << endl : std::cout << "EDX bit 20: " << edxBits[20] << ": [UNSUPPORTED] Reserved" << endl;
	...
	std::cout << "EAX=0xC0000006: Feature bits in EAX:" << endl; //" << std::hex << "0x" << ZeroPadNumber(cpuInfo[0], 1) << endl;
	(eaxBits[0]) ? std::cout << "EAX bit 0: " << eaxBits[0] << ": [SUPPORTED] PAUSEOPT instruction - (pauseopt)" << endl : std::cout << "EAX bit 0: " << eaxBits[0] << ": [UNSUPPORTED] PAUSEOPT instruction - (pauseopt)" << endl;
